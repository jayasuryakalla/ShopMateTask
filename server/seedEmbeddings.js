...
if (!geminiApiKey) {
  console.error(
    "CRITICAL ERROR: GEMINI_API_KEY is not defined in environment variables."
  );
}
...
if (!pineconeApiKey) {
  console.error(
    "CRITICAL ERROR: PINECONE_API_KEY is not defined in environment variables."
  );
}
...
if (!pineconeIndex) {
  console.error(
    "CRITICAL ERROR: PINECONE_INDEX is not defined in environment variables."
  );
}
